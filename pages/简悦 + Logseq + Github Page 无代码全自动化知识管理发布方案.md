...
- # 流程
	- 在 Web 端使用简悦标注，并通过简悦的同步助手自动将以 Markdown 形式的标注导入到 Logseq page 文件夹，并使用 Hazel（或 crontab ）自动 Push 到 Github repo 后通过 Logseq Publish GitHub Action 自动发布的全流程无代码自动化发布方案。
		- 大致可以包含以下两类：
			- {{embed ((61fdf55a-6c68-46ba-884b-ee36441e3062))}}
			- {{embed ((61fdf55a-1fd9-4ee7-a05b-b36acb897b16))}}
- # 演示
...
- # 至此
	- id:: 61fdf55a-23b9-429d-996d-797c43827be9
	  > 全部配置结束，上述配置包含
		- 当你在 Logseq 页面的任何改动都会自动发布到你的 Github Page 上面，[示例一](((61fdf55a-49d3-4471-b629-d804de8d6ff3))) 。
		  id:: 61fdf55a-6c68-46ba-884b-ee36441e3062
		- 在简悦中的任意标注都会发布到你的 Github Page 上面，[示例二](((61fdf55a-2cf2-4e79-b3f4-f5b14d86611e))) 。
